    ...
    <div
      ...
      <nav
        ...
        <div
          ...
          <div
            className={`hamburger-menu ${isHamburgerOpen ? 'open' : ''} group h-full md:hidden flex flex-col transition-all duration-500 ease-[cubic-bezier(0.77,0,0.175,1)] items-center justify-center cursor-pointer gap-[6px] order-2 md:order-none`}
            onClick={toggleMenu}
            role="button"
          ...
          <div
            className=" flex items-center md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 order-1 md:order-none">
             <h1 className=' font-semibold '> Skill Cricle</h1>
          </div>


          <div  className="card-nav-cta-button hidden md:inline-flex gap-5  text-center flex items-center rounded-[calc(0.75rem-0.2rem)] px-4 h-full font-medium  transition-colors duration-300">
            <a
               href='/about'
              type="button"
              className=' text-xs'
